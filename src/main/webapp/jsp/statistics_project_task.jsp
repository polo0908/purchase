			        ...
			        <table class="grid">
			            ...
			            <tbody>
			             <c:forEach items="${noFinishList}" var="noFinish">
				              <tr <c:if test="${noFinish.roleNo == 6}">style="background-color:#9bd89b;font-weight: 800;"</c:if>>
				                <td>
			        ...
			        <table class="grid">
			            ...
			            <tbody>
			             <c:forEach items="${finishList}" var="finish">
				              <tr <c:if test="${finish.roleNo == 6}">style="background-color:#9bd89b;font-weight: 800;"</c:if>>
				                <td>
			        ...
			        <table class="grid">
			            ...
			            <tbody>
			             <c:forEach items="${onTimeList}" var="onTime">
				              <tr <c:if test="${onTime.roleNo == 6}">style="background-color:#9bd89b;font-weight: 800;"</c:if>>
				                <td>
