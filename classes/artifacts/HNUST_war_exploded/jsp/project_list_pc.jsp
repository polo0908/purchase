...
<body class="list-bgcolor">
	...
	<div class="main-container page1">
			...
			<div class="form-group form-group2" style="height: 40px;">
				<div class="col-sm-4">
					...
					<!-- 改变 开始-->
						<div class="dropdown dropdown1">
							  ...
							  <ul>
							   	<li class="first-li"><label><input type="checkbox" checked="checked"> 全部状态</label></li>
      							<li><label><input type="checkbox"> 新立项项目</label></li>
      							<li><label><input type="checkbox"> 正常进行项目</label></li>
      							<li><label><input type="checkbox"> 完成项目</label></li>
   								<li><label><input type="checkbox"> 延期项目</label></li>
   								<li><label><input type="checkbox"> 暂停项目</label></li>
   								<li><label><input type="checkbox"> 取消项目</label></li>
							  </ul>
						</div>
					<!-- 改变 结束-->
				...
				<div class="col-sm-4 col-sm-4_2">
					...
					<div class="dropdown dropdown2">
						  ...
						  <div class="div_transparent"></div>
						  <ul class="ul2">
						   	<li class="first-li"><label><input type="checkbox" checked="checked"> 全部阶段</label></li>
   							<li><label><input type="checkbox"> 样品</label></li>
   							<li><label><input type="checkbox"> 模具</label></li>
   							<li><label><input type="checkbox">大货</label></li> 								  								
						  </ul>
					</div>
					<!-- 改变 结束-->
				</div>
				<div class="col-sm-4">
					...
					<!-- 改变 开始-->
						<div class="dropdown dropdown3">
							  ...
							  <div class="div_transparent"></div>
							  <ul class="ul3">
							   	<li class="first-li"><label><input type="checkbox" checked="checked"> 全部等级</label></li>
      							<li><label><input type="checkbox"> 未定</label></li>
		...
		<div class="main-table meeting-list-table">		
						...
						<table class="grid">
							...
							<thead>
								<tr>
									...
									<th style="width: 140px"><span class="tab-link">项目状态</span></th>
			...
			<div class="page-box">
				总数:${totalCount}每页:<select><option>5</option><option>10</option><option>20</option><option>所有</option></select>条 当前页/总页:<span style='color: red' id="pageNumberSpan"></span>/<span id="countPageSpan"
		    ...
		    <a href="#" class='emanagergetpagea' title='4' class='a02'>4</a> -->
				<a href="#" class='emanagergetpagea' onclick="searchProjectData(3)"
					...
					<div class="c_g">
						<select><option>采购名称列表1</option><option>采购名称列表2</option><option>采购名称列表3</option></select>
						<a href="" target=_blank>任务完成情况查询</a>
					</div>
			</div>
...
<script type="text/javascript">
	...
	function searchProjectData(obj){
		...
		var plantAnalysis=$('#plantAnalysis').val();
								...
								for(var i=0;i<projectDataList.length;i++){
								    ...
								    if(project.zhijian1){
							          ...
							          if(project.productImg){
							        	if(project.productImg){
								        	 pichtml= '<img style="max-height: 100px;max-width: 190px;" src="/product_img/'+project.productImg+'"></img>'
								        }
							          }
									  ...
									  tabhtml+='<td style="width: 190px">'+pichtml+'</td>'
									  tabhtml+='<td style="width: 140px">'+(project.weekInfo?project.weekInfo:"")+'</td>'
									       +'<td style="width: 90px">'
									       +'<span></span><button class="new_add">新增</button>'
									       /* +'<div class="add_tc">'
									       +'<textarea></textarea>'
									       +'<div class="btns">'
									       +'<button class="pull-left">取消</button>'
									       ...
									       +'</div>' */
									       +'</td>'
									       +'<td style="width: 158px">'+(project.companyName?project.companyName:"")+'</td>'
									       if(qualityReport!=null){  
