...
public class DbTaskPoolUtil {
	private static final Log LOG = LogFactory.getLog(DbTaskPoolUtil.class);
...
//			long st = System.currentTimeMillis();
			...
			synchronized (DbTaskPoolUtil.class) {
				InputStream ins = DbTaskPoolUtil.class.getResourceAsStream("/jdbc.properties");
