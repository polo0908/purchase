...
public class DbCrmPoolUtil {
	private static final Log LOG = LogFactory.getLog(DbCrmPoolUtil.class);
...
//			long st = System.currentTimeMillis();
			...
			synchronized (DbCrmPoolUtil.class) {
				InputStream ins = DbCrmPoolUtil.class.getResourceAsStream("/jdbc-crm.properties");
