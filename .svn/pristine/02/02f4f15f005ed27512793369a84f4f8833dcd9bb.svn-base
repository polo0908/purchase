...
public class Project extends PageHelper implements Serializable {
	...
	public String toString() {
		return "Project [id=" + id + ", projectNo=" + projectNo
				...
				+ purchaseId + ", poDate=" + poDate + ", scheduledDate="
				+ scheduledDate + ", actualStartDate=" + actualStartDate
				+ ", createDate=" + createDate + ", finish=" + finish
				+ ", isPause=" + isPause + ", pauseReason=" + pauseReason
				+ ", inputKey=" + inputKey + ", delayList=" + delayList
				+ ", planList=" + planList + ", reportList=" + reportList
				...
				+ purchaseName + ", sellName=" + sellName + ", qualityName="
				+ qualityName + ", userName=" + userName + ", roleNo=" + roleNo
				+ ", status=" + status + ", zhijian1=" + zhijian1
				+ ", zhijian2=" + zhijian2 + ", zhijian3=" + zhijian3
				+ ", projectAmount=" + projectAmount + ", weekPicture="
				+ weekPicture + ", weekInfo=" + weekInfo + ", sortField="
				+ sortField + ", finishTime=" + finishTime
				...
				+ ", plantAnalysis=" + plantAnalysis + ", plantAnalysisView="
				+ plantAnalysisView + ", projectMaterialProperties="
				+ projectMaterialProperties + ", technology=" + technology
