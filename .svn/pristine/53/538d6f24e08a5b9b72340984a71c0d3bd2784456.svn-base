...
<div class="project_task_detail">
	...
	<div class="contact clearfix">
		...
		<div class="task-li-right">
			...
			<ul class="project_detail_ul">
				...
				<li>
					...
					<c:choose>
						<c:when test="${fn:containsIgnoreCase(projectTask.description, '编制检验计划')}">
						   <span> <a target="_blank" href="http://112.64.174.34:33168/po/POupload.aspx?id=${projectTask.projectNo}">${projectTask.projectNo} </a></span>
					    </c:when>
					    <c:otherwise>
				...
				<li class="wid-all">
					<a href="http://112.64.174.34:10010/project/showDetails?projectNo=${projectTask.projectNo}" style="color:red;">检验计划要求速览</a>
				</li>
	...
	<div class="mission-status">			
			<a class="select_blank btn" href="http://112.64.174.34:10010/user/toIndex" target="_blank">返回功能选择页</a>					
			<a class="select_blank btn" href="http://112.64.174.34:33168/" target="_blank">跳转ERP</a>
			<a class="select_blank btn" href="http://112.64.174.34:43888/New-Quotation/quotation/login.jsp" target="_blank">跳转内部报价系统</a>								
