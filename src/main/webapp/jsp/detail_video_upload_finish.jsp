...
<html>
	<head>
		...
		<title>任务系统，手机详情，视频上传，完成任务</title>		
...
<body>
	<div class="quality detail_video_upload">
		<div class="add_title_div">
			...
			<p class="mt10 red">为了减少视频体积，节约网络流量，请用微信先上传到“文件传输助手”进行压缩，然后保存到手机，发送压缩过的视频。
			上传的视频会根据项目，出现在微信质检报告的末尾</p>
			...
			<!-- <div class="divs mt10">
				...
				<div class="form-group">
					<label><input type="checkbox" /> 验厂/拍工厂环境和展品的</label>					
				</div>
				<div class="form-group">					
					<label><input type="checkbox" /> 对应质检报告的</label>
				</div>
			</div> -->
			...
			<div class="btn btn-default display_block mt10 bgcolor_ff0" onclick="save_video('<%=projectNo%>','<%=userName%>','<%=taskId%>')">提交所有已经上传视频</div>
 ...
 function save_video(projectNo,userName,tId){
	  ...
	  $('form').each(function(){
		  ...
		  var factoryVideo = {"factoryName":factoryName,"factoryId":factoryId,"qualityVideoName":fileName,
				  "videoFile":filePath,"projectNo":projectNo,"uploader":userName,"remark":remark,"taskId":taskId}
